...
# Load data
with open(r"C:\Users\bunsr\OneDrive\Bunsree\OneDrive\Desktop\ML Practice\Bispecific_mAb\ML Practice_Structure_Based_HAC_Module_Bispecific_mAb.csv") as file:
    print(file.read())

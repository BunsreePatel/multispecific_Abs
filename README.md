...
Phase 2: Fold Fab and Fv structures with ColabFold and compute all four structure-based feature engineering modules
...
Fab structures required appending CH1 and CL constant regions, while Fv-based formats involved mapping format-specific linker sequences. All PDBs were folded using Google AlphaFold2.ipynb with AMBER relaxation enabled (see [`colabfold/`](./colabfold/)).
